        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li><a href="<?php echo base_url(); ?>"><i class="fa fa-eye"></i> Profil</a></li>
                    <li><a href="<?php echo base_url(); ?>"><i class="fa fa-comments"></i> about</a></li>   
                </ul>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-6">           
                        <div class="panel panel-primary text-center no-boder bg-color-red">
                            ...
                            <div class="panel-footer back-footer-red">
                                <a style="color:white" href="<?php echo base_url();?>paket">SOAL</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-6">           
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-6">           
                        <div class="panel panel-primary text-center no-boder bg-color-blue">
                            ...
                            <div class="panel-footer back-footer-blue">
                                <a style="color:white" href="<?php echo base_url();?>user">PESERTA</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-6">           
