                            ...
                            <div class="col-md-6">
                                <form role="form" action="<?php echo base_url(); ?>soal/update" method="POST">
                                        ...
                                        <select class="form-control" name="paket" style="width: 100;">
                                          ...
                                          foreach($paket as $kat){
                                            if(!in_array($kat['paket'],$label_post)){
                                              ?>
                                              <option value="<?php echo $kat['paket'] ?>"><?php echo $kat['paket'] ?></option>
                                              <?php } else { ?>
                                              <option selected="selected" value="<?php echo $kat['paket'] ?>"><?php echo $kat['paket'] ?></option>
                                              <?php } } ?>
                                          </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="e" value="<?php echo $e; ?>" />
                                    </div>
                                    <div class="form-group">
